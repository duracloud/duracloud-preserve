use apputils::bucket::{
    BUCKET_REQUEST_CONTENT_TYPE, BucketValidationError, MAX_BUCKETS_PER_REQUEST,
    MAX_REQUEST_FILE_SIZE,
};

pub use apputils::bucket::{
    BUCKET_TAG_STACK_KEY, BUCKET_TAG_TYPE_KEY, Bucket, Name, REPLICATION_SUFFIX, Request, Type,
    pair_buckets, review_bucket_names,
};
...
/// Error type for bucket-domain validation + AWS request failures.
#[derive(Debug, Error)]
